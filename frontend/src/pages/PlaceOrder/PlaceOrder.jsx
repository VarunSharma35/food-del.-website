  ...
  return (
    <form onSubmit={placeOrder} className="place-order">
      ...
      <div className="place-order-right">
        ...
        {/* COD Button */}
        <button type="submit" onClick={() => setPaymentMethod("cod")} className='paymentbuttoncod' >CASH ON DELIVERY</button>
        
        {/* Stripe Button */}
        <button type="submit" onClick={() => setPaymentMethod("stripe")} className='paymentbuttonstripe'>ONLINE PAYMENT</button>
      </div>
    </form>
  );
};
